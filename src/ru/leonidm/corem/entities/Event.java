...
public enum Event {
    ...
    ENTITY_DEATH, ENTITY_SPAWN, ENTITY_DAMAGE, ENTITY_DAMAGE_BY_ENTITY,

    PLAYER_BREAK_BLOCK, PLAYER_CHANGE_WORLD, PLAYER_INVENTORY_CLICK, PLAYER_JOIN, PLAYER_QUIT, PLAYER_TELEPORT,
    PLAYER_INTERACT_BLOCK, PLAYER_INTERACT, PLAYER_INVENTORY_CLOSE, PLAYER_INTERACT_ENTITY, PLAYER_INTERACT_AT_ENTITY,
    PLAYER_PLACE_BLOCK, PLAYER_CHANGE_SLOT,
